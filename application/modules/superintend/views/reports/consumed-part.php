<form action="<?php echo base_url('oversee/print-consumed-parts');?>" method="POST" class="form-horizontal" role="form">
<div class="row">
    <div class="col-md-12">
        <div class="card-box">
                    ...
                    <div class="col-md-12">
                        <div class="card bg-light">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="btn_generate_consume" class="btn btn-success waves-effect waves-light">
                                    Generate
                                </button>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btn_generate_consume").on("click", function(e){
