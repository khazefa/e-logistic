<div class="row">
    ...
    <div class="col-md-9">
        <div class="card-box">
            <button type="button" onclick="location.href='<?php echo base_url("add-supply-from-fsl");?>'" class="btn btn-custom btn-rounded w-md waves-effect waves-light">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#data_grid').DataTable({
            ...
            ajax: {                
                url: '<?php echo base_url('front/csupplyfromfsl/get_list_view_datatable'); ?>',
                type: 'POST',
