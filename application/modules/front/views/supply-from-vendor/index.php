            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6"><label class="col-form-label">Vendor Name</label></div>
                            <div class="col-md-6" id="trans_vendor_name"></div>
                        </div>

                        <div class="row">
                            <div class="col-md-6"><label class="col-form-label">Vendor Address</label></div>
                            <div class="col-md-6" id="trans_vendor_address"></div>
                        </div>

                        <div class="row">
                            <div class="col-md-6"><label class="col-form-label">PO Number</label></div>
