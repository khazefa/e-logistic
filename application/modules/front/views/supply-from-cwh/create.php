...
//            scrollCollapse: true,
            ...
            lengthChange: false,
            ajax: {
                url: "<?= base_url('front/csupplyfromcwh/get_view_delivery_note_detail'); ?>",
                type: 'GET',
...
//            },
    ...
    function check_trans_out(transnum){
        var url = '<?php echo base_url('front/csupplyfromcwh/check_supply_from_cwh'); ?>';
        var type = 'POST';
        var data = {
    ...
    function get_outgoing_info(transnum){
        var url = '<?php echo base_url('front/csupplyfromcwh/get_view_delivery_note'); ?>';
        var type = 'GET';
        var data = {
            <?php echo $this->security->get_csrf_token_name(); ?> : "<?php echo $this->security->get_csrf_hash(); ?>",  
            ftrans_out : transnum
    ...
    function complete_trans(){
        var url = '<?php echo base_url('front/csupplyfromcwh/submit_trans_close_transfer'); ?>';
        var type = 'POST';
...
//                    alert('Close Transfer Stock Success!');
                    window.location.href = "<?php echo base_url('supply-from-cwh'); ?>";
                }
            },
            error: function(jqXHR, textStatus, errorThrown) {
                // Handle errors here
