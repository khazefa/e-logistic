<div class="row">
    <div class="col-md-12">
        <div class="card-box">
            <button type="button" onclick="location.href='<?php echo base_url("new-fsltocwh-trans");?>'" class="btn btn-custom btn-rounded w-md waves-effect waves-light">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#data_grid').DataTable({
            ...
            lengthChange: true,
            ajax: {                
                url: "<?= base_url('front/cfsltocwh/get_list_view_datatable'); ?>",
                type: "POST",
                dataType: "JSON",
