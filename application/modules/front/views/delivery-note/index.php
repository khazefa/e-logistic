<div class="row">
    <div class="col-md-12">
        <div class="card-box">
            <button type="button" onclick="location.href='<?php echo base_url("new-delivery-note-trans");?>'" class="btn btn-custom btn-rounded w-md waves-effect waves-light">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#data_grid').DataTable({
            ...
            lengthChange: true,
            ajax: {                
                url: "<?= base_url('front/cdeliverynote/get_list_view_datatable'); ?>",
                type: "POST",
                dataType: "JSON",
            ...
            columns: [
                { "data": 'delivery_note_num' },
                { "data": 'transdate' },
                { "data": 'purpose' },
                { "data": 'qty' },
                { "data": 'user' },
                { "data": 'delivery_note_status' },
                { "data": 'button' },
            ],
            order: [[ 0, "desc" ]],
            columnDefs: [{ 
