...
//            $this->mypdf->ln(20);
    ...
    //            $this->mypdf->SetProtection(array('print'));// restrict to copy text, only print
            ...
            $this->mypdf->Cell(($width*(80/100)),7,'Report Date:',0,0,'R');
            $this->mypdf->setFont('Arial','B',10);
            $this->mypdf->CellFitScale(($width*(10/100)),7,$reportdateID,0,1, 'R');

            $this->mypdf->ln(10);
            $this->mypdf->setFont('Arial','B',13);
            $this->mypdf->Cell(($width-20),7,'Daily Report Consumed Part '.$fslname,0,1,'C');
            $this->mypdf->ln(2);
...
//            $this->mypdf->ln(10);
            ...
            $this->mypdf->ln(10);
            $this->mypdf->Cell(($width*(25/100)),6,$createdBy,0,1,'L');
...
//            $this->mypdf->ln(20);
    ...
    //            $this->mypdf->SetProtection(array('print'));// restrict to copy text, only print
            ...
            $this->mypdf->ln(10);
            $this->mypdf->setFont('Arial','B',13);
            $this->mypdf->Cell(($width-20),7,'Report Replenish Plan '.$fslname,0,1,'C');
            $this->mypdf->ln(2);
            // Garis atas untuk header
    //        $this->mypdf->Line(10, $height/3.9, $width-10, $height/3.9);
