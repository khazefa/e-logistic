                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" value="<?=$rs['delivery_note_purpose'];?>" disabled="true">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="fdest_fsl" class="col-sm-3 col-form-label">Transaction Number</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="ftransnum" value="<?=$rs['delivery_note_num'];?>" disabled="true">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="fdest_fsl" class="col-sm-3 col-form-label">FSL Destination</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="<?=$rs['fsl_code'];?>" disabled="true">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="fairwaybill" class="col-sm-3 col-form-label">No Airwaybill <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?=$rs['delivery_note_airwaybill'];?>" disabled="true">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="ftransnotes" class="col-sm-3 col-form-label">Transaction Notes </label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?=$rs['delivery_note_notes'];?>" disabled="true">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="fairwaybill2" class="col-sm-3 col-form-label">DN From Delivery <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?=$rs['delivery_note_airwaybill2'];?>" disabled="true">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="fdeliveryby" class="col-sm-3 col-form-label">Delivered By <span class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="<?=$rs['delivery_by'];?>" disabled="true">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="fservice" class="col-sm-3 col-form-label">Service <span class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="<?=$rs['delivery_time_type'];?>" disabled="true">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?=$rs['delivery_note_eta'];?>" disabled="true">
                                    </div>
                                </div>
                            </div>
                        </div>
...
//            scrollCollapse: true,
            ...
            lengthChange: false,
            ajax: {
                url: link('get_list_cart_datatable_edit'),
                type: "POST",
                dataType: "JSON",
                headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                contentType: "application/json",
            ...
            columnDefs : [
                {
                    ...
                    render    : function ( data, type, full, meta ) {
                        e_qty.html(parseInt(e_qty.html())+full.qty);
                        if(full.isdetail!==true){
                            return '<button type="button" class="btn btn-danger" id="btn_delete"><i class="fa fa-trash"></i></button>';
                        }else{
                            return '<button type="button" class="btn btn-danger" id="btn_delete" disabled><i class="fa fa-trash"></i></button>'
                        }
                    }
                },
                {
