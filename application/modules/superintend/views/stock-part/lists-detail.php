...
<script type="text/javascript">
    ...
    function init_detail(fcode, fpartnum){
        tabel_d = $('#detail_grid').DataTable({
            ...
            ajax: {                
                url: '<?=base_url('oversee/list-detail-spareparts-stock');?>',
                type: 'POST',
...
//                        columns: ':visible:not(:last-child)',
            ...
            ajax: {                
                url: "<?= base_url('superintend/cstockpart/get_m_list_datatable/').$code; ?>",
                type: "POST",
                dataType: "JSON",
                contentType: "application/json",
                data: JSON.stringify( {
...
//                { "data": 'button' },
        ...
        //                        columns: ':visible:not(:last-child)',
                    ...
                    ajax: {                
                        url: "<?= base_url('superintend/cstockpart/get_list_partsub_datatable/').$code; ?>",
                        type: "POST",
                        dataType: "JSON",
                        contentType: "application/json",
                        data: JSON.stringify( {
