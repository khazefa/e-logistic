                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="column col-md-6">
                                        ...
                                        <button type="button" id="btn_add" class="btn btn-primary waves-effect waves-light" 
                                                data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Add more data..">
                                            <i class="fa fa-plus-square-o" aria-hidden="true"></i> Add more
                                        </button>
                                    </div>
                                    <div class="column col-md-6">
...
<script type="text/javascript">    
    ...
    function init_table(){
        table = $('#data_grid').DataTable({
            dom: "<'row'<'col-sm-12'><'col-sm-8'><'col-sm-4'>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-9'><'col-sm-3'>>",
            searching: true,
            ordering: false,
            info: false,
            paging: false,
...
//                    print_transaction(jqXHR.message);
    ...
    $(document).ready(function() {
        ...
        $('#fpartnum').on( 'keyup', function () {
            //https://www.datatables.net/release-datatables/examples/api/regex.html
